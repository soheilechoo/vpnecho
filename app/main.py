...
# ============================================================
# تابع کمکی برای ویرایش ایمن پیام (رفع خطای message is not modified)
# ============================================================
...
# ============================================================
# دریافت رسید (رفع خطای DetachedInstanceError)
# ============================================================
...
async def process_receipt(message: types.Message, state: FSMContext):
    ...
    # همه کارهای دیتابیس داخل یک بلاک
    with get_db() as session:
        db_user = session.query(User).filter_by(telegram_id=user.id).first()
        if not db_user:
            db_user = User(telegram_id=user.id, username=user.username, first_name=user.first_name)
...
# ============================================================
# تایید و رد پرداخت توسط ادمین (رفع خطای DetachedInstanceError)
# ============================================================
